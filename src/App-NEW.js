              ...
              <Router>
                ...
                >
                  ...
                  <Text
                    ...
                    ml="10px"
                  >
                    UX Part II: Smart-Contract Transactions
                  </Text>
                  <Text
                    mt="2px"
                    fontWeight="bold"
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">query</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://query.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Smart-Contracts Query
                  </Link>
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">promo</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://promo.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Hero Promotions
                  </Link>
                  {/* FIND A PLAYER */}
                  <hr />
                  <Text
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">players</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">buildagig</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                  ...
                  <Text
                    ...
                    ml="10px"
                  >
                    UX Part VI: Player and App Gallery
                  </Text>
                  <Text
                    mt="2px"
                    fontWeight="bold"
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">appgallery</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://appgallery.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Players and Apps Gallery
                  </Link>
                  {/* INSTRCTION MANUAL */}
                  <hr />
                  <Text
                    ...
                    ml="10px"
                  >
                    UX Part VII: Meta-Collab User's Guide
                  </Text>
                  <Text
                    mt="2px"
                    fontWeight="bold"
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">usersguide</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://usersguide.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Meta-Collab User's Guide
                  </Link>
                  {/* PLAYER PROFILE */}
                  <hr />
                  <Text
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">profile</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://profile.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">images</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">cards</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://cards.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Cards
                  </Link>
                  ...
                  <Text
                    ...
                    ml="50px"
                  >
                    <Text fontSize="1.5rem" color="cyan">demos</Text>.metacollab.freeweb3.com
                  </Text>
                  <Link ml="80px" fontSize="1rem" fontWeight="bold" 
                    href="https://demos.metacollab.freeweb3.com"
                    style={{ marginTop: "2px" }}
                  >
                    Go to Demos
                  </Link>
